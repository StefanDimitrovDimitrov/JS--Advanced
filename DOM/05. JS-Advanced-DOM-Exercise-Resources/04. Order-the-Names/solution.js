function solve() {
    ...
    btn.addEventListener("click", ()=>{
        let array = document.getElementsByTagName("ol")[0].children;//document.getElementsByTagName("li")

        let currentName = input.value.toString()[0].toUpperCase()+ input.value.slice(1).toLowerLowerCase();
